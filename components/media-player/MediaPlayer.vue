...
<template>
  <div class="shrink-0" :class="{ 'w-[400px]': open }">
    <div
      class="large-shadow group fixed bottom-5 right-5 z-30 flex w-[400px] flex-col overflow-hidden rounded-2xl bg-background-1 transition-all duration-700 ease-out-expo"
      :style="{
