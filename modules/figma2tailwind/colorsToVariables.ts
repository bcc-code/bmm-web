...
function createTailwindColors(obj: InputObject | NestedVariableObject, prefix: string): Record<string, any> {
...
export default function generateStylesAndConfig(input: InputObject): StyleConfig {
